...
import type { ConfirmedInfo } from './FallbackIdentityStep';

// ─────────────────────────────────────────────
// Types
// ─────────────────────────────────────────────

export interface ConfirmInfoStepProps {
  info: ConfirmedInfo;
  onConfirm: (confirmed: ConfirmedInfo) => void;
}
...
// ─────────────────────────────────────────────
// Validation helpers (mirrors FallbackIdentityStep)
// ─────────────────────────────────────────────
...
export function ConfirmInfoStep({ info, onConfirm }: ConfirmInfoStepProps) {
  const uid = useId();
  ...
  const handleSubmit = useCallback(
    (e: React.FormEvent<HTMLFormElement>) => {
      ...
      // Preserve the original source from the incoming info
      onConfirm({ ...values, source: info.source });
    },
    [values, info.source, onConfirm]
  );

  const isPrefill = info.source === 'prefill';
...
export default ConfirmInfoStep;
